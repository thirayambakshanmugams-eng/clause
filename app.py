...
def create_app():
    ...
    allowed_origins = [
        'https://clauseguard.onrender.com',
        'https://clause.onrender.com',
        'http://localhost:5000',
        'http://127.0.0.1:5000',
    ]
    ...
    def login():
        """Secure login route with brute-force protection."""
        import time
        if request.method == 'POST':
            ...
            if username == APP_USERNAME and check_password_hash(APP_PASSWORD_HASH, password):
                ...
                return render_template('login.html',
                    error=f'Invalid username or password. {remaining_tries} attempt(s) remaining.')
        return render_template('login.html')
